...
typedef int (*dubai_mtk_power_stats_fn_t)(void);
typedef int (*dubai_get_sysmon_stats_fn_t)(struct dubai_sysmon_stats *data);
typedef int (*dubai_get_subsystem_sleep_stats_fn_t)(
	struct honor_sleep_stats *rpmh_data, struct honor_sleep_stats *soc_data,
	int subsystem_num);

struct dubai_wakeup_stats_ops {
	dubai_suspend_notify_fn_t suspend_notify;
	dubai_wakeup_stats_fn_t get_stats;
	dubai_mtk_power_stats_fn_t get_mtk_power_stats;
