...
struct power_platform_dc_charger_ops{
	...
	bool (*hihonor_direct_charge_in_charge_done_stage)(void);
	unsigned int (*hihonor_direct_charge_get_stage_status)(void);
	int (*hihonor_direct_charge_get_cur_ibat_th_high)(void);
};
...
int power_interface_dc_get_cur_ibat_th_high(void);
