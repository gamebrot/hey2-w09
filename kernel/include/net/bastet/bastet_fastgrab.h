...
/* maybe 0xFFFF is valid. But this macro is only used to filter DNS port, 
   so this macro can be any value except ntohs(DNS_PORT_NUM) */
#define BST_FG_INVALID_PORT 0xFFFF
