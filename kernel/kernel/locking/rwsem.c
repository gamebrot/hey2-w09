...
#if defined(CONFIG_HN_VIP_THREAD) ||  defined(CONFIG_HN_QOS_THREAD)
/*
...
#ifdef CONFIG_HN_VIP_THREAD_BUILDIN
	trace_android_vh_honor_rwsem_list_add(&waiter, sem, &already_on_list);
#endif
...
#ifdef CONFIG_HN_VIP_THREAD_BUILDIN
	trace_android_vh_honor_rwsem_vip_set(&waiter, sem);
#endif
#ifdef CONFIG_HN_QOS_THREAD
