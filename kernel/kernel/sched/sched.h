...
#ifdef CONFIG_CFS_BANDWIDTH_DATA_STAT
	/* Record for running time in a period */
	unsigned int running_pct[RUNNING_PCT_NUM];
#endif
#endif
};
...
static inline void register_sched_domain_debugfs(void)
{
}
