...
static bool is_parrot = false;
extern bool hn_check_product_filter(void);
static __init int sched_init_debug(void)
{
	bool need_filter = false;
	is_parrot = check_arch_desc("Parrot");

	need_filter = hn_check_product_filter();
	if (is_parrot || need_filter)
...
void register_sched_domain_debugfs(void)
{
	int cpu, i;
...
void register_sched_domain_sysctl(void)
{
	...
	need_filter = hn_check_product_filter();
	if (check_arch_desc("Parrot") || need_filter) {
		register_sched_domain_debugfs();
		return;
	}
