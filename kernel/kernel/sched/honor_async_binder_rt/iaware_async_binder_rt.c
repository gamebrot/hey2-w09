...
#else //CONFIG_HN_ASYNC_BINDER_THREAD_PRIO_RT
const char async_binder_rt_descriptor[] = {'a', '\0', 'n', '\0', 'd', '\0', 'r', '\0', 'o', '\0',
					   'i', '\0', 'd', '\0', '.', '\0', 'g', '\0', 'u', '\0',
					   'i', '\0', '.', '\0', 'I', '\0', 'T', '\0', 'r', '\0',
					   'a', '\0', 'n', '\0', 's', '\0', 'a', '\0', 'c', '\0',
					   't', '\0', 'i', '\0', 'o', '\0', 'n', '\0', 'C', '\0',
...
{
	return async_binder_rt_descriptor;
}

unsigned int get_descriptor_size()
{
	return sizeof(async_binder_rt_descriptor);
}
#endif