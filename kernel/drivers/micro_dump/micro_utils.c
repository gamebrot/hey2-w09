...
void micro_symbol_init(void)
{
	...
	micro_sched_schedstats = *(struct static_key_false*)kallsyms_lookup_name("sched_schedstats");
...
{
	unsigned long low, high;
	unsigned long *micro_overflow_stack = (unsigned long *)kallsyms_lookup_name("overflow_stack");
