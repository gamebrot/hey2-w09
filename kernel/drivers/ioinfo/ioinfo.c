...
#endif
#ifdef CONFIG_HONOR_REFAULT_REPORT
...
#ifdef CONFIG_HONOR_REFAULT_REPORT
extern atomic_long_t active_ta_refault_count;
extern atomic_long_t inactive_ta_refault_count;
extern atomic_long_t active_fg_refault_count;
extern atomic_long_t inactive_fg_refault_count;
#endif
...
static void io_info_output_msg(struct io_output_info *pio_inf)
{
	...
	len += snprintf(buf + len, IOSTAT_BUFLEN - len,
		" file:%lu free:%lu slab:%lu refault:%lu pgpress:%lu%%",
		pio_inf->pgstat.pgfile, pio_inf->pgstat.free, pio_inf->pgstat.slab, pio_inf->pgstat.refault, get_pgpress());
#endif
#ifdef CONFIG_HONOR_REFAULT_REPORT
	len += snprintf(buf + len, IOSTAT_BUFLEN - len,
		" active_ta_refault_count:%lu, inactive_ta_refault_count:%lu, active_fg_refault_count:%lu, inactive_fg_refault_count:%lu, total_refault_count:%lu",
		atomic_long_read(&active_ta_refault_count), atomic_long_read(&inactive_ta_refault_count),
		atomic_long_read(&active_fg_refault_count), atomic_long_read(&inactive_fg_refault_count),
...
#ifdef CONFIG_HONOR_PGPRESS
	io_dev_get_cachestats(&g_io_inf);
#endif
