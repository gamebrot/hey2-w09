...
static int is_valid_log_meta_info(struct bootfail_meta_log *pinfo)
{
	...
	if (pinfo->logs_info[0].kernel_log.size != run_param.adp.kernel_log_ops.log_size) {
		run_param.adp.print("func: is_valid_log_meta_info, invalid metainfo, update rrecord");
		return 0;
	}
