...
#ifdef CONFIG_HONOR_THERMAL
#include <log/log_usertype.h>
#define BETA_USER_TYPE				3
#endif
				...
				u16 adc_code, int *result_mdec)
{
	...
	*result_mdec = temp;
#ifdef CONFIG_HONOR_THERMAL
	if (*result_mdec >= 160000) {
		if (get_logusertype_flag() == BETA_USER_TYPE) {
			pr_err("thermal abnormal high temp, temp=%d\n", *result_mdec);
			panic("THERMAL_ABNORMAL_HIGH_TEMP");
		}
	}
#endif
